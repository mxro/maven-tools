...
public class TestThatPathsDeterminedCorrectlyInLocalRepository {
  @Test
  public void test() {
    Dependency _define = Dependency.define("com.appjangle.java", 
      "appjangle-jre", "0.3.6");
    File _file = new File("/data/databases/localMavenRepository/");
    final File file = MavenLocalRepository.getFolderInLocalRepository(_define, _file);
    String _absolutePath = file.getAbsolutePath();
    TestThatPathsDeterminedCorrectlyInLocalRepository.<String, String>operator_doubleArrow(_absolutePath, "/data/databases/localMavenRepository/com/appjangle/java/appjangle-jre/0.3.6");
  }
